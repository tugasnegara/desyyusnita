...
public class transaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        struk.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        struk.setText("STRUK");
        ...
        no_tran.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        no_order.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_pel.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_tbayar.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_bayar.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_status.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_sisa.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        form_sisa.setForeground(new java.awt.Color(255, 255, 255));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setText("Dibayar      :");

        form_dibayar.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        form_kembalian.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        tabel_tran.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    private void strukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_strukActionPerformed
        if(Desktop.isDesktopSupported()){
                    try{
                        Desktop.getDesktop().browse(new URL("http://localhost/Laundry/struk.php?id="+ no_tran.getText()).toURI());
                } catch(Exception e){
                        e.printStackTrace();
                }
        }
